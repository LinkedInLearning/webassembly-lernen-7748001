# WebAssembly (Wasm) lernen – Einstieg mit Python

Dies ist das Repository für den **LinkedIn Learning** Kurs `WebAssembly (Wasm) lernen – Einstieg mit Python`. Den gesamten Kurs finden Sie auf [LinkedIn Learning][lil-course-url].
...
[lil-URL-trainer]: https://www.linkedin.com/learning/instructors/ralph-steyer
